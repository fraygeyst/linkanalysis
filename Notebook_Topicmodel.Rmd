...
plot.STM(model7, type ="summary", text.cex = 0.3)

```


``` {r}
plot(model5, type = "label", topics = c(9, 32, 7, 33), main = "Themenbegriffe")
...
cloud(model7, topic=9, max.words = 100)
cloud(model7, topic=32, max.words = 100)
cloud(model7, topic=7, max.words = 100)
...
```{r}
plot.STM(model5, type="perspectives", topics = c(9,32))
```
